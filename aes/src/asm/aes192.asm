...
@aes192_encrypt_block_internal@20 proc
    pxor xmm0, [ecx]
    aesenc xmm0, [ecx + 10h]
    aesenc xmm0, [ecx + 20h]
    aesenc xmm0, [ecx + 30h]
    ...
    ret
@aes192_encrypt_block_internal@20 endp

@aes192_decrypt_block_internal@20 proc
    pxor xmm0, [ecx]
    aesdec xmm0, [ecx + 10h]
    aesdec xmm0, [ecx + 20h]
    aesdec xmm0, [ecx + 30h]
    ...
    ret
@aes192_decrypt_block_internal@20 endp

@aes192_expand_key_internal@36 proc
...
aes192_keygen_assist:
    ...
    ret
@aes192_expand_key_internal@36 endp

@aes192_derive_decryption_keys_internal@8 proc
    movdqa xmm5, [ecx]
    ...
    ret
@aes192_derive_decryption_keys_internal@8 endp
