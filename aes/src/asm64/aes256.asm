...
aes256_encrypt_block_internal proc
    movdqa xmm0, [rcx]
    pxor xmm0, [rdx]
    aesenc xmm0, [rdx + 10h]
    aesenc xmm0, [rdx + 20h]
    ...
    aesenclast xmm0, [rdx + 0E0h]
    ret
aes256_encrypt_block_internal endp

aes256_decrypt_block_internal proc
    movdqa xmm0, [rcx]
    pxor xmm0, [rdx]
    aesdec xmm0, [rdx + 10h]
    aesdec xmm0, [rdx + 20h]
    ...
    aesdec xmm0, [rdx + 0C0h]
    aesdec xmm0, [rdx + 0D0h]
    aesdeclast xmm0, [rdx + 0E0h]
    ret
aes256_decrypt_block_internal endp

aes256_expand_key_internal proc
    ...
    movdqa [r8 + 10h], xmm1    ; sets w[4], w[5], w[6], w[7]
    lea r8, [r8 + 20h]         ; r8 = &w[8]
...
aes256_keygen_assist:
    ...
    ret
aes256_expand_key_internal endp

aes256_derive_decryption_keys_internal proc
    movdqa xmm5, [rcx]
    movdqa xmm4, [rcx + 0E0h]
    movdqa [rdx], xmm4
    movdqa [rdx + 0E0h], xmm5

    aesimc xmm5, [rcx + 10h]
    aesimc xmm4, [rcx + 0D0h]
    movdqa [rdx + 10h], xmm4
    movdqa [rdx + 0D0h], xmm5

    aesimc xmm5, [rcx + 20h]
    aesimc xmm4, [rcx + 0C0h]
    movdqa [rdx + 20h], xmm4
    ...
    ret
aes256_derive_decryption_keys_internal endp
