...
; Copied from asm/aes192.asm, accounting for the calling convention changes.
...
aes192_encrypt_block_internal proc
    movdqa xmm0, [rcx]
    pxor xmm0, [rdx]
    aesenc xmm0, [rdx + 10h]
    aesenc xmm0, [rdx + 20h]
    ...
    aesenclast xmm0, [rdx + 0C0h]
    ret
aes192_encrypt_block_internal endp

aes192_decrypt_block_internal proc
    movdqa xmm0, [rcx]
    pxor xmm0, [rdx]
    aesdec xmm0, [rdx + 10h]
    aesdec xmm0, [rdx + 20h]
    ...
    aesdec xmm0, [rdx + 80h]
    aesdec xmm0, [rdx + 90h]
    aesdec xmm0, [rdx + 0A0h]
    aesdec xmm0, [rdx + 0B0h]
    aesdeclast xmm0, [rdx + 0C0h]
    ret
aes192_decrypt_block_internal endp

aes192_expand_key_internal proc
...
aes192_keygen_assist:
    ...
    ret
aes192_expand_key_internal endp

aes192_derive_decryption_keys_internal proc
    movdqa xmm5, [rcx]
    movdqa xmm4, [rcx + 0C0h]
    movdqa [rdx], xmm4
    movdqa [rdx + 0C0h], xmm5

    aesimc xmm5, [rcx + 10h]
    aesimc xmm4, [rcx + 0B0h]
    movdqa [rdx + 10h], xmm4
    movdqa [rdx + 0B0h], xmm5

    aesimc xmm5, [rcx + 20h]
    aesimc xmm4, [rcx + 0A0h]
    movdqa [rdx +  20h], xmm4
    movdqa [rdx + 0A0h], xmm5
    ...
    ret
aes192_derive_decryption_keys_internal endp
